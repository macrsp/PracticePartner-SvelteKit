# Planner Screen Context Coverage Manifest
...
| --- | --- | --- | --- | --- |
| focus | planner-screen | `src/lib/ui/planner/**` | path missing | 0 |
| focus | planner-screen | `src/routes/planner/+page.svelte` | present | 1 |
