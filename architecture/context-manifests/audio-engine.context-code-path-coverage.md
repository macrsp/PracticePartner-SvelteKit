# Audio Engine Context Coverage Manifest
...
| focus | audio-engine | `src/lib/engines/audio/**` | path missing | 0 |
| focus | audio-engine | `src/lib/platform/browser/audio/**` | path missing | 0 |
| focus | audio-engine | `src/lib/platform/browser/media/**` | path missing | 0 |
