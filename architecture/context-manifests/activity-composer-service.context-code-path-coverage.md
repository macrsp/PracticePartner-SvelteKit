# Activity Composer Service Context Coverage Manifest
...
- `activity-composer-service` (focus)
...
| focus | activity-composer-service | `src/lib/app/activity-composer/**` | path missing | 0 |
| focus | activity-composer-service | `src/lib/ui/planner/**` | path missing | 0 |
| focus | activity-composer-service | `src/lib/ui/player/**` | path missing | 0 |
