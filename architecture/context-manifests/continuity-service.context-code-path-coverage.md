# Continuity Service Context Coverage Manifest
...
| focus | continuity-service | `src/lib/app/continuity/**` | path missing | 0 |
| focus | continuity-service | `src/lib/platform/browser/db/**` | path missing | 0 |
| focus | continuity-service | `src/lib/platform/browser/fs/**` | path missing | 0 |
