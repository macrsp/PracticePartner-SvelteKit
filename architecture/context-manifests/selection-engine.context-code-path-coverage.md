# Selection Engine Context Coverage Manifest
...
| focus | selection-engine | `src/lib/app/selection/**` | path missing | 0 |
| focus | selection-engine | `src/lib/engines/selection/**` | path missing | 0 |
| focus | selection-engine | `src/lib/ui/player/**` | path missing | 0 |
