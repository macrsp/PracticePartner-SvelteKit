# Navigation Service Context Coverage Manifest
...
| focus | navigation-service | `src/lib/app/navigation/**` | path missing | 0 |
| focus | navigation-service | `src/routes/+layout.ts` | present | 1 |
| focus | navigation-service | `src/routes/+page.ts` | present | 1 |
