# Waveform Engine Context Coverage Manifest
...
| focus | waveform-engine | `src/lib/engines/waveform/**` | path missing | 0 |
| focus | waveform-engine | `src/lib/platform/browser/media/**` | path missing | 0 |
| focus | waveform-engine | `src/lib/ui/player/**` | path missing | 0 |
