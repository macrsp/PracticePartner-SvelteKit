# Activity Service Context Coverage Manifest
...
- `activity-service` (focus)
- `activity-composer-service` (collaborator)
- `plan-service` (collaborator)
...
| focus | activity-service | `src/lib/app/activities/**` | path missing | 0 |
| focus | activity-service | `src/lib/domains/activities/**` | path missing | 0 |
| collaborator | activity-composer-service | `src/lib/app/activity-composer/**` | path missing | 0 |
| collaborator | activity-composer-service | `src/lib/ui/planner/**` | path missing | 0 |
| collaborator | activity-composer-service | `src/lib/ui/player/**` | path missing | 0 |
| collaborator | plan-service | `src/lib/app/plans/**` | path missing | 0 |
| collaborator | plan-service | `src/lib/domains/plans/**` | path missing | 0 |
